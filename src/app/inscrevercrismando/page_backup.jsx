...
export default function InscreverCrismando() {
  ...
  const handleCepChange = (e) => {
    ...
    let formattedCep = value.replace(/\D/g, ''); // Remove caracteres não numéricos
  ...
  const handleFileChange = (e, fieldName) => {
    ...
    if (file) {
      ...
      if (file.type.startsWith('image/')) {
        ...
        // Para PDFs e outros arquivos, apenas marcar como enviado
        setImagePreview(prev => ({
          ...prev,
          [fieldName]: 'uploaded'
        }));
  ...
  const handleSubmit = (e) => {
    ...
    // Combinar nome e sobrenome, e criar endereço completo
                ...
                <div className={styles.uploadGroup}>
                  <label className={styles.uploadLabel}>
                    {imagePreview.foto && imagePreview.foto !== 'uploaded' ? (
                      <img src={imagePreview.foto} alt="Foto de perfil" className={styles.uploadedPhoto} />
                    ) : (
                      <>
                        <FaUpload className={styles.uploadIcon} />
                        <span>Foto do Crismando *</span>
                      </>
                    )}
                  </label>
                  <input
